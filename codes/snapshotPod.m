...
function [phiVecForModeM]=snapshotPod(currentAzimuthalMode,currentCrossSection,currentCorrMat,currentUvec  )
%function pod()
%figure(1);
...
phiVecForModeM(podModeNumber).dat(rr) = ad/(eigVal(tt,tt)*ntimesteps); % smits.eq.2.5
